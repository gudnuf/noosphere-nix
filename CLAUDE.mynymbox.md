...
**Host:** mynymbox (NixOS Cloud VM - x86_64)
**User:** claude
...
This is a placeholder file for the mynymbox cloud VM configuration. This host is not yet fully configured.
...
```bash
nrs  # Alias for: sudo nixos-rebuild switch --flake ~/.config/nix-config#mynymbox
```
